...
if (localSettings) {
    ...
    simulation.speedrunModeEnabled = localSettings.speedrunModeEnabled
    document.getElementById("speedrun-mode").checked = localSettings.speedrunModeEnabled
} else {
    localSettings = {
    ...
    document.getElementById("difficulty-select").value = localSettings.difficultyMode
    document.getElementById("fps-select").value = localSettings.fpsCapDefault
    document.getElementById("speedrun-mode").value = localSettings.speedrunModeEnabled
}
...
document.getElementById("speedrun-mode").addEventListener("input", () => {
    simulation.speedrunModeEnabled = document.getElementById("speedrun-mode").checked
    localSettings.speedrunModeEnabled = simulation.speedrunModeEnabled
    localStorage.setItem("localSettings", JSON.stringify(localSettings)); //update local storage
});
