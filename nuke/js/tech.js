const tech = {
    ...
    tech: [{
        ...
        {
            name: "tactical nuke",
            description: "spawns a <strong class='flicker'>tactical nuke</strong>. <strong class='color-d'>Do you want to die</strong>?<br><strong>Warning: includes a small jumpscare.</strong>",
            maxCount: 1,
            count: 0,
            frequency: 0,
            frequencyDefault: 0,
            ...
            requires: "",
            effect() {
                simulation.makeTextLog("<strong class='color-d'>TACTICAL NUKE: INCOMING!</strong>")
                // play the nuke sound            
                nukeSound.play()
                // start the nuke
                b.nuke(Vector.clone(player.position))
            },
            remove() {}
        },
        {
